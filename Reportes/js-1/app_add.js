document.addEventListener("DOMContentLoaded", () =>{
    ...
    let form = document.getElementById("agregar_estacion");
   
    form.addEventListener("submit",function(event){
        event.preventDefault();
        enviar_data(this,"agregar_estacion","Estacion creada!");
    });
})

document.addEventListener("DOMContentLoaded", () =>{

    let form = document.getElementById("editar_estacion");
   
    form.addEventListener("submit",function(event){
        event.preventDefault();
        enviar_data(this,"editar_estacion","Estacion editada!");
    });
})
