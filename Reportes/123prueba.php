...
<?php
		...
		?>	
                        <tr>    
                                <td></td>
                                <td colspan='13' style="text-align:center;background-color:#3c8dbc;font-size:120%;font-weight:bold">DATOS DE LA ESTACION</td>
                                ...
                                <td colspan='2' style="text-align:center;background-color:#ffc107;font-size:120%;font-weight:bold">EQUIPO RETIRADO</td>
                                <td colspan='3' style="text-align:center;background-color:#ffc107;font-size:120%;font-weight:bold">EQUIPO INSTALADO</td>
                                                ...
                                                if($count_preventivo!=false){
                                                        while($row_preventivo=sqlsrv_fetch_array($query_preventivo)){
                                                                ...
                                                                if($fecha_inicial!=false){
                                                                                $fecha_inicial=$row_preventivo['fechaInicio']->format('d-m-Y');
                                                                                $dia_i=$row_preventivo['fechaInicio']->format('d');   
                                                                                $mes_i=$row_preventivo['fechaInicio']->format('m');   
                                                                                $ano_i=$row_preventivo['fechaInicio']->format('Y');   
                                                                                
                                                                                $fecha_final=$row_preventivo['fechaFinal']->format('d-m-Y'); 
                                                                                $dia_f=$row_preventivo['fechaFinal']->format('d');   
                                                                                $mes_f=$row_preventivo['fechaFinal']->format('m');   
                                                                                $ano_f=$row_preventivo['fechaFinal']->format('Y');   
                                                                ...
                                                                $contenido_tabla.= "<td>ejecutado no ejecutado</td>";
                                                                $contenido_tabla.= "<td>obs sobre no ejecutado</td>";
