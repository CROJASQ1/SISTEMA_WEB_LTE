...
if(isset($_POST['fechaini']) && isset($_POST['fechafin'])){
    ...
    if($regional>0){
        ...
        AND tp.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ...
        AND tex.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ...
        WHERE td.dato like 'NO' AND tc.idCampo=td.idCampo AND tp.fechaInicio>=' $fechaini' and tp.fechaInicio<='$fechafin' AND te.idRegional=$regional AND tp.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ...
        WHERE td.dato like 'NO' AND tc.idCampo=td.idCampo AND tex.fechaInicio>=' $fechaini' and tex.fechaInicio<='$fechafin' AND te.idRegional=$regional AND tex.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ) tmp GROUP BY tmp.mes)
        ...
        (select tmp.mes,count(tmp.mes) no FROM 
        (select te.idRegional,td.dato,tp.fechaInicio,MONTH(tp.fechaInicio) AS mes from tblPreventivo tp,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
        WHERE td.dato like 'SI' AND tc.idCampo=td.idCampo AND tp.fechaInicio>=' $fechaini' and tp.fechaInicio<='$fechafin' AND te.idRegional=$regional AND tp.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ) tmp GROUP BY tmp.mes
        UNION ALL
        select tmp.mes,count(tmp.mes) no FROM 
        (select te.idRegional,td.dato,tex.fechaInicio,MONTH(tex.fechaInicio) AS mes from tblExtraCanon tex,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
        WHERE td.dato like 'SI' AND tc.idCampo=td.idCampo AND tex.fechaInicio>=' $fechaini' and tex.fechaInicio<='$fechafin' AND te.idRegional=$regional AND tex.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
        ) tmp GROUP BY tmp.mes)
        ...
        $pdf->Cell(0,5,"GRAFICO:  ".$nombre_regional." Disponibilidad de enlaces",0,1,'C');
        ...
        if (sizeof($todos)>0) {
            ...
            (select tmp.mes,count(tmp.mes) no FROM 
            (select te.idRegional,td.dato,tp.fechaInicio,MONTH(tp.fechaInicio) AS mes from tblPreventivo tp,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
            WHERE td.dato like 'NO' AND tc.idCampo=td.idCampo AND tp.fechaInicio>=' $fechaini' and tp.fechaInicio<='$fechafin' AND tp.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
            ) tmp GROUP BY tmp.mes
            UNION ALL
            select tmp.mes,count(tmp.mes) no FROM 
            (select te.idRegional,td.dato,tex.fechaInicio,MONTH(tex.fechaInicio) AS mes from tblExtraCanon tex,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
            WHERE td.dato like 'NO' AND tc.idCampo=td.idCampo AND tex.fechaInicio>=' $fechaini' and tex.fechaInicio<='$fechafin' AND tex.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
            ) tmp GROUP BY tmp.mes)
            ...
            (select tmp.mes,count(tmp.mes) no FROM 
            (select te.idRegional,td.dato,tp.fechaInicio,MONTH(tp.fechaInicio) AS mes from tblPreventivo tp,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
            WHERE td.dato like 'SI' AND tc.idCampo=td.idCampo AND tp.fechaInicio>=' $fechaini' and tp.fechaInicio<='$fechafin' AND tp.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
            ) tmp GROUP BY tmp.mes
            UNION ALL
            select tmp.mes,count(tmp.mes) no FROM 
            (select te.idRegional,td.dato,tex.fechaInicio,MONTH(tex.fechaInicio) AS mes from tblExtraCanon tex,tblEstaciones te,tblDetalleFormulario td,tblCampo tc,tblFormulario tf
            WHERE td.dato like 'SI' AND tc.idCampo=td.idCampo AND tex.fechaInicio>=' $fechaini' and tex.fechaInicio<='$fechafin' AND tex.idFormulario=tf.idFormulario AND te.idEstacion=tf.idEstacion AND tf.idFormulario=td.idFormulario AND tc.idCampo=455
            ) tmp GROUP BY tmp.mes)
             tmp1 GROUP BY tmp1.mes) x2 ON x1.mes=x2.mes) tempo3 WHERE tempo1.mes=tempo2.mes and tempo1.mes=tempo3.mes";
    // echo $sql;
            ...
            $pdf->AddPage();
            $pdf->SetFont("Arial","B",14);
            $pdf->Cell(0,5,"GRAFICO: Todos (Disponibilidad de enlaces)",0,1,'C');
            $pdf->SetFont("Times","",12);
            if (sizeof($todos)>0) {
                    $pdf->barrasgraficoPDFAgrupadoPares($todos,'ReportePdf',array(50,30,120,70),'VISITA Y REMOTO');
