...
/* ----------------------------------------------------- */
                if(isset($_POST['fechaini']) && isset($_POST['fechafin'])){
                        ...
                        $sql_consulta="SELECT * FROM tblFormulario WHERE idFormulario IN (49,1162,1247,1113,1184,1210,1417,1604);";
                        $sql_consulta="SELECT TOP 1000 * FROM tblFormulario;";
                }
         ...
         /*        if($sql_consulta===false){
                        ...
                        if($count_consulta_g!=false){
                                        ...
                                        while($row_arriba=sqlsrv_fetch_array($query_arriba)){
                                                ...
                                                while($row_formulario=sqlsrv_fetch_array($query_formulario)){  
                                                      ...
                                                      /*   $contenido_tabla.= "<td>".$id_formulario."</td>"; */
                                                        $contenido_tabla.= "<td>".utf8_decode($row_formulario['idEstacion'])."//".$id_formulario."</td>";
                                        ...
                                        /* correctivos */
                                                ...
                                                echo $consulta_formulario_final.'<br>';
                                                                ...
                                                                if($tamaño_vector==0){
                                                                        ...
                                                                        if($tama_vector == 0){
                                                                                ...
                                                                                for ($i=0; $i < $tama_vector; $i++) { 
                                                                                        echo 'option2-'.$i.'<br>';
                                                                                        print_r($vector_equipo_reemplazo[$i]); echo '<br>';
                                                                                        print_r($vector_modelo_retirado[$i]); echo '<br>';
                                                                                        print_r($vector_serie_retirado[$i]); echo '<br>';
                                                                                        print_r($vector_modelo_reemplazo[$i]); echo '<br>';
                                                                                        print_r($vector_serie_reemplazo[$i]); echo '<br>';
                                                                                        print_r($vector_observaciones[$i]); echo '<br>';
                                                                                        echo '----------->>>>'.$i.'<br>';
                                                                                        if(isset($vector_equipo_reemplazo[$i]) && strlen(trim($vector_equipo_reemplazo[$i]))>0 && isset($vector_modelo_retirado[$i]) && strlen(trim($vector_modelo_retirado[$i]))>0 && isset($vector_serie_retirado[$i]) && strlen(trim($vector_serie_retirado[$i]))>0 && isset($vector_modelo_reemplazo[$i]) && strlen(trim($vector_modelo_reemplazo[$i]))>0 && isset($vector_serie_reemplazo[$i]) && strlen(trim($vector_serie_reemplazo[$i]))>0 && isset($vector_observaciones[$i]) && strlen(trim($vector_observaciones[$i]))>0){
                                                                                                ...
                                                                                                $cadena = trim(trim($grupito).trim($vector_equipo_reemplazo[$i]).trim($vector_modelo_retirado[$i]).trim($vector_serie_retirado[$i]).trim($vector_modelo_reemplazo[$i]).trim($vector_serie_reemplazo[$i]).trim($vector_observaciones[$i]));
