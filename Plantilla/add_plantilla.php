       ...
       <br>
            ...
            <form id="crear_plantilla">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="plantilla" class="form-control" placeholder="Escriba el plantilla..." autocomplete='off' required >
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-4">
                        <input type="button" id="add_plantilla" class="btn btn-lg btn-primary" onclick="guardarplantilla()" value="Guardar">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="button" id="add_plantilla" class="btn btn-lg btn-primary" onclick="guardarplantilla()" value="Guardar datos">
                            <a href="plantilla.php" class="btn btn-lg btn-danger">Volver al listado</a>
                        </div>
                    </div> 
